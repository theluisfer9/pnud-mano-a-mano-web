        ...
        <>
          <main className="home-content">
            <div className="home-text-container">
              <h1>
                ¿Qué es la{" "}
                <strong>Iniciativa Intersectorial Mano a Mano?</strong>
              </h1>
              <p>
                Es un <strong>esfuerzo colaborativo</strong> que busca{" "}
                <strong>
                  responder a las necesidades humanas más urgentes
                </strong>{" "}
                de los y las guatemaltecas en situación de vulnerabilidad,
                teniendo como objetivo principal la contribución al bienestar y
                mejora progresiva la calidad de vida.
              </p>
              <p>
          ...
          <section className="home-dimensions">
            <div className="home-dimensions-container">
              ...
              <div className="objective-text-container">
                ...
                <p>
                  Actuar de manera <strong>integral y multidimensional</strong>{" "}
                  para reducir la pobreza y malnutrición en territorio nacional.
                </p>
              </div>
            </div>
          </section>
                    ...
                    <div className="info-item-c">
                      ...
                      <div className="info-text">
                        ...
                        <p>
                          ...
                          elit. Phasellus interdum nulla ut sapien volutpat, ac
                          fermentum justo hendrerit.
                        </p>
                      </div>
                    </div>
                    <hr />
